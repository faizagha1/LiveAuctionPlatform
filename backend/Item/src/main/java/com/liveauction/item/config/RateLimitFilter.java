...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final int CREATE_ITEM_REQUESTS_PER_MINUTE = 20; // Stricter for item creation
    ...
    private int getRateLimitForEndpoint(HttpServletRequest request) {
        ...
        if (path.equals("/api/v2/items") && method.equals("POST")) {
            return CREATE_ITEM_REQUESTS_PER_MINUTE;
        }
